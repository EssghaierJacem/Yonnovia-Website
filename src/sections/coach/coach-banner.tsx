...
export function CoachBanner({ sx, ...other }: BoxProps) {
  return (
    <Box
      component="section"
      sx={[
      ...
      <Container component={MotionContainer}>
        ...
        >
          <AnimateText
            component="h1"
            variant="h1"
            textContent={["ADA'Z", 'le coach IA des enfants']}
          ...
          <m.div variants={varFade('inUp', { distance: 24 })}>
            ...
            >
              Un guide intelligent pour accompagner
              <br />
              les enfants dans leurs aventures entrepreneuriales
            </Typography>
          </m.div>
        </Box>
      </Container>
