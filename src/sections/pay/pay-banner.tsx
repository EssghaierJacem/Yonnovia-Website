...
export function PayBanner({ sx, ...other }: BoxProps) {
  return (
    <Box
      component="section"
      sx={[
      ...
      <Container component={MotionContainer}>
        ...
        >
          <AnimateText
            component="h1"
            variant="h1"
            textContent={["Kid'Pay", 'Finance éducative']}
          ...
          <m.div variants={varFade('inUp', { distance: 24 })}>
            ...
            >
              Un système de paiement éducatif pour apprendre
              <br />
              aux enfants la gestion financière.
            </Typography>
          </m.div>
        </Box>
      </Container>
