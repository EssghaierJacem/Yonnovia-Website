...
export function HomeIntegrations({ sx, ...other }: BoxProps) {
  const renderDescription = () => (
    <SectionTitle
      caption="Notre Solution : B-Bot"
      title="Un assistant business 8-en-1 pensé pour les"
      txtGradient="TPE et indépendants"
      description={
        <>
          <Box component="span" sx={{ mb: 1, display: 'block' }}>
            • Gestion : Facturation, clients, conformité KYC • Automatisation : Analyse d'activité,
            alertes, rapports automatiques • Assistance : Suivi de tâches, rappels, interactions
            vocales
          </Box>
