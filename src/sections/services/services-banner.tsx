...
export function ServicesBanner({ sx, ...other }: BoxProps) {
  return (
    <Box
      component="section"
      sx={[
      ...
      <Container component={MotionContainer}>
        ...
        >
          ...
          <m.div variants={varFade('inUp', { distance: 24 })}>
            ...
            >
              Des services sur-mesure pour accompagner votre transformation digitale
              <br />
              et booster la performance de votre entreprise avec Yonnov'IA.
            </Typography>
          </m.div>
        </Box>
      </Container>
